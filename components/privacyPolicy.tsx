export default function PrivacyPolicy() {
  return (
    <div>
      <p>
        This privacy policy outlines how delegates.kssha.co.ke collects, uses,
        and protects any personal information provided by users of our website.
        KSSHA is committed to ensuring that your privacy is protected. Should we
      ...
      <div>
        <p className="font-bold py-2">Information Collection and Use</p>
        <p>
          ...
          surveys and/or offers. We require this information to understand your
          needs and provide you with a better service, and in particular for the
          following reason - From time to time, we may also use your information
      ...
      <div>
        <p className="font-bold py-2">Security</p>
        <p>
          ...
          and secure the information we collect online. We will not sell,
          distribute, or lease your personal information to third parties unless
          we have your permission or are required by law to do so. We may use
          your personal information to send you promotional information about
          third parties which we think you may find interesting if you tell us
          that you wish this to happen. If you believe that any information we
      ...
      <div>
        <p className="font-bold py-2">Cookies</p>
        <p>
      ...
      <div>
        <p className="font-bold py-2">Data Retention</p>
        <p>
      ...
      <div>
        <p className="font-bold py-2">Changes to This Privacy Policy</p>
        <p>
          ...
          ensure that you are familiar with any changes. We will also notify you
          of any significant changes to the privacy policy via the email address
          you provided, if applicable.
        </p>
      </div>
      <div>
        ...
        changes to this policy will be deemed as your acceptance of those
        changes.
      </div>
    </div>
  );
